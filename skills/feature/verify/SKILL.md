...
Read `${CLAUDE_PLUGIN_ROOT}/skills/feature/quality-gate/SKILL.md` and follow it — it resolves the final test and lint commands (stack-specific convention overrides + monorepo scoping).
